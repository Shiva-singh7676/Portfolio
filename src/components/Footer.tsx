...
function Footer() {
  return (
    <footer className="bg-gradient-to-b from-indigo-900 via-purple-700 to-black text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex space-x-3 pt-2">
              <motion.a 
                href="https://github.com/Shiva-singh7676" 
                target="_blank" 
              ...
              <motion.a 
                href="https://www.linkedin.com/in/shiva-singh-8aa477261?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" 
                target="_blank" 
                rel="noopener noreferrer"
                whileHover={{ scale: 1.1 }}
                className="bg-white/10 p-2 rounded-full hover:bg-white/20 transition-colors"

...
const socialLinks = [
  {
    name: 'GitHub',
    icon: Github,
    url: 'https://github.com/Shiva-singh7676',
  ...
  },
  {
    name: 'LinkedIn',
    icon: Linkedin,
    url: 'https://www.linkedin.com/in/shiva-singh-8aa477261?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
  ...
  },
  {
    name: 'LeetCode',
    icon: Code2,
    url: 'https://leetcode.com/u/shiva_singh78/',
    stats: ['100+ Problems'],
